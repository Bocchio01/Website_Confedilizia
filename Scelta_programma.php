...
<html lang="it">
<head>
	<meta name="google-site-verification" content="google-site-verification=CGt1qssU80LUfrSGIXtuZPftTuM4XJkWSq6zNWzdusk">
    <style type="text/css">
        @import url("Style_php_.css");
    </style>
</head>
<body>
    <title>Software ConfediliziaComo</title>
    <meta charset="UTF-8">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <h2>software ConfediliziaComo</h2>
                        <div id="articolo">
                            <br>
                            <table width="100%">
                                <tbody>
