...
<?php echo render('./template/site/head.php', array('title' => 'Scelta della versione'), 1); ?>
    ...
    <div align="center">
        <table style="border: 0px; background-color: white; width:1000px;" cellpadding="0" cellspacing="0">
            <tbody>
                ...
                <?php echo (render('./template/site/menu.php', array('title' => 'Prospetto di calcolo', 'subtitle' => 'scelta versione'))); ?>
